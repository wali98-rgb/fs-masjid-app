<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('admin.dashboard') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-semibold ms-2">Masjid Al-...</span>
        </a>
    </div>
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item {{ request()->is('cms-admin') ? 'active' : '' }}">
        ...
        <!-- Sumbangan -->
        <li class="menu-header mt-7"><span class="menu-header-text">Sumbangan</span></li>
        <!-- Sumbangan -->
        ...
        <!-- Profil -->
        <li class="menu-header mt-7"><span class="menu-header-text">Profil</span></li>
        <!-- Profil -->
